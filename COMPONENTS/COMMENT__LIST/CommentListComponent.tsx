    ...
    return (
        <div className='w-screen h-screen grid grid-cols-4 grid-rows-3 place-items-center'>
            {commentsData.map((item: SingleCoinType) => (
                <div key={item.id} className='w-[30rem] h-[30rem] flex items-center justify-center text-xl tracking-tighter font-bold bg-gradient-to-br from-zinc-900 via-gray-900 to-zinc-950 text-white'>
