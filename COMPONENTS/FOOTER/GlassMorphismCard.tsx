...
const GlassMorphismCard: React.FC<GlassmorphismCardProps> = ({ product }) => {
   return (
      <div className="relative bg-white bg-opacity-10 backdrop-blur-xl border border-gray-200 rounded-xl shadow-lg p-6 transition-transform transform hover:scale-105 hover:shadow-2xl flex flex-col justify-center">
         {/* Product Image */}
         ...
         <div className="flex items-center justify-between mt-4">
            ...
            <Tooltip title="Add to Cart">
               <Button type="primary" icon={<ShoppingBasket className="w-5 h-5" />} className="bg-blue-500 hover:bg-blue-600 border-none text-white rounded-lg px-4 py-2"   >
                  Buy Now
               </Button>
            </Tooltip>
         </div>
