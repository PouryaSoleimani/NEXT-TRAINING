    ...
    return (
        <>
            ...
            <div className="w-full flex items-center justify-center py-5">
                <Button variant="outline" onClick={() => toastHandler()} className="text-white  font-semibold px-4 py-8 leading-tight tracking-tighter m-0 rounded border-zinc-800 flex text-base" >
                    Show Toast
                </Button>
            </div>
        </>
