    ...
    <>
      ...
      <div className='flex flex-wrap items-center justify-center mt-6 px-10 gap-4'>
        {data.map((product: SingleProductType) => (
          <div key={product.id} className='bg-sky-800 flex w-[30rem] my-2 hover:bg-zinc-800 cursor-pointer items-center justify-between pl-2 pr-4 py-4 text-2xl font-semibold rounded-md'>
