    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white'>
            ...
            <main className='container mx-auto px-4 py-12'>
                ...
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='text-xl text-center mb-12 font-light tracking-wide text-gray-400'  > Transform your web development journey  </motion.p>
                ...
                <div className='space-y-16'>
                    ...
                    <motion.section initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0 }} className='bg-gradient-to-r from-gray-900 to-black backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-gray-800'    >
                        <h2 className='text-3xl font-bold mb-6 text-white'>   Essential Concepts  </h2>
