...
function DropDownPage() {
    return (
        <div className='w-screen h-screen flex  items-center justify-center bg-gradient-to-br from-zinc-900 via-zinc-950 to-black'>
            ...
            <div id='WRAPPER' className='w-fit h-fit relative z-50'>
                <button id='DROPDOWN____BTN' className='w-64 justify-center py-2 bg-blue-800 hover:bg-blue-900  rounded text-2xl font-semibold tracking-tight duration-200 text-white flex items-center gap-4'>
                    Toggle
