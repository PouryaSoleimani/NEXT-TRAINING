...
const SortTest: NextPage<props> = ({ products }) => {
  ...
  return (
    <div >
      ...
      <div id="SortingButtons" className='bg-lime-800 px-10 py-3 flex items-center justify-center space-x-5'>
        <button onClick={sortAscending} className='bg-black font-bold p-2 rounded-md hover:bg-zinc-800 duration-300'>Cheapest</button>
