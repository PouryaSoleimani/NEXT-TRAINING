...
import { StyledFilledButton , StyledOutLineButton } from '@/STYLED__COMPONENTS/COMPONENTS'
    ...
    return (
        <>
            ...
            <div className='flex item-center justify-center space-x-10 border-t-8 border-[#FABB14] p-10'>
                <StyledFilledButton>تایید</StyledFilledButton>
                <StyledOutLineButton>لغو</StyledOutLineButton>
            </div>
        </>
    )
}
