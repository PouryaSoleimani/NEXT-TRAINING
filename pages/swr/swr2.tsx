...
const swr2 = () => {
    ...
    return (
        <div className='grid grid-cols-3 gap-4 p-10 swr2'>
            {data.map((item: any) => (
                <div key={item.id} className='bg-white opacity-30 hover:opacity-100 text-end text-black px-4 py-5 my-2 rounded-md w-[30rem] cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out'>
