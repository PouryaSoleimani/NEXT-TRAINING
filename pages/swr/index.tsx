...
const SWR: NextPage<Props> = ({ }) => {
  ...
  const { data, error, isLoading } = useSWR('http://localhost:4000/products', fetcher)
  ...
  return (
    ...
    <div>
      ...
      <div className='bg-zinc-900 p-8 font-bold flex flex-col items-start justify-center space-y-4 text-2xl'>
