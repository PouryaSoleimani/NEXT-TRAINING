...
const DatePickerComponent = () => {
    ...
    return (
        <div className="flex flex-col space-y-2 items-center justify-center h-screen font-extrabold tracking-tighter text-3xl">
            ...
            <div dir="rtl">
                <DatePicker value={value} onChange={event => dateChangeHandler(event)} calendar={persian} locale={persian_fa} className="bg-dark" animations={[transition({ duration: 800, from: 35 })]} />
            </div>
        </div>
    )
}
