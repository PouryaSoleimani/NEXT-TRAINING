...
const DynamicSSgPage: NextPage<Props> = ({ data }) => {
  ...
  return (
    <div className='flex flex-col space-y-10 items-center justify-center w-screen h-screen text-7xl font-semibold'>
      <h1 className='bg-zinc-800 p-10 rounded-md border'>{data.id} - {data.title} : <span className='bg-green-600 px-2 rounded-md border-2 border-green-800'>${data.price}</span></h1>
